  ...
  },
  {
    ...
    properties: [
      ...
      { key: 'attachments', label: 'Attachments', type: 'textarea',
        placeholder: '["C:\\\\reports\\\\summary.csv"]',
        helpText: 'JSON array of file paths. Only SMTP/email uses attachments; other channels ignore them.' },
      { key: 'into', label: 'Into Variable', type: 'text',
  ...
  // Local Command
  {
    ...
    properties: [
      ...
      { key: 'into', label: 'Into Prefix', type: 'text',
        placeholder: 'result',
        helpText: 'Foreground sets stdout/stderr/exit_code. Tracked interactive sets exit_code. Background and detached interactive set pid/started/start_error.', group: 'core' },
      timeoutProp,
      onErrorProp,
    ],
  },
